...
<div class="section product product-list">
    <div class="container">
        ...
        <div class="input-field">
            <select>
                <option value="2">最畅销</option>
                <option value="1">最新商品</option>
                <option value="3">最佳好评商品</option>
                <option value="4">从低到高</option>
                <option value="5">从高到低</option>
            </select>
        </div>
        <div class="row">
            @foreach($data as $v)
            <div class="col s6">
                <div class="content">
                    ...
                    <button class="btn button-default">查看详情</button>
                </div>
            </div>
            @endforeach
        </div>
